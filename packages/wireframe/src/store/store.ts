function getImg(str: string): string {
  return str;
}
...
let SectionData = {
  logoData: [
    {
      imgClass: 'logo-dark',
      logoImg: getImg('files/images/logo-black.png'),
      path: '/home'
    },
    {
      imgClass: 'logo-light',
      logoImg: getImg('files/images/logo-white.png'),
      path: '/home'
    }
  ],
  // Hero data
  heroData: {
    ...
    img: getImg('files/images/thumb/nft.jpg')
  },
  // Hero data two
  heroDataTwo: {
    ...
    img: getImg('files/images/thumb/nft-img.png')
  },
  // Hero data three
  heroDataThree: {
  ...
  heroDataEight: [
    ...
    {
      id: 3,
      img: getImg('files/images/thumb/nft-full-3.jpg'),
  ...
  productData: {
    ...
    products: [
      {
        id: 1,
        img: getImg('files/images/thumb/nft-2.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg.jpg'),
        ...
        avatar: getImg('files/images/thumb/avatar.jpg'),
        ...
        avatars: [
          {
            id: 1,
            img: getImg('files/images/thumb/avatar.jpg'),
            path: '/author'
          },
          {
            id: 2,
            img: getImg('files/images/thumb/avatar-2.jpg'),
            path: '/author'
          },
          {
            id: 3,
            img: getImg('files/images/thumb/avatar-3.jpg'),
            path: '/author'
          },
          {
            id: 4,
            img: getImg('files/images/thumb/avatar-4.jpg'),
            path: '/author'
          },
          {
            id: 5,
            img: getImg('files/images/thumb/avatar-5.jpg'),
            path: '/author'
          },
        ],
      },
      {
        id: 2,
        img: getImg('files/images/thumb/nft3.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg2.jpg'),
        ...
        avatar: getImg('files/images/thumb/avatar-2.jpg'),
      ...
      {
        id: 3,
        img: getImg('files/images/thumb/nft4.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg3.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-3.jpg'),
      ...
      {
        id: 4,
        img: getImg('files/images/thumb/nft5.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg4.jpg'),
        ...
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-4.jpg'),
      ...
      {
        id: 5,
        img: getImg('files/images/thumb/nft6.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg5.jpg'),
        ...
        avatar: getImg('files/images/thumb/avatar-5.jpg'),
      ...
      {
        id: 6,
        img: getImg('files/images/thumb/nft7.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg6.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-6.jpg'),
      ...
      {
        id: 7,
        img: getImg('files/images/thumb/nft8.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg7.jpg'),
        ...
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-7.jpg'),
      ...
      {
        id: 8,
        img: getImg('files/images/thumb/nft9.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg8.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-8.jpg'),
      ...
      {
        id: 9,
        img: getImg('files/images/thumb/nft16.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg9.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-9.jpg'),
        userName: '@radio_caca',
        followersText: '1.4k Followers',
      ...
      {
        id: 10,
        img: getImg('files/images/thumb/nft17.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg10.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-10.jpg'),
      ...
      {
        id: 11,
        img: getImg('files/images/thumb/nft18.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg11.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">2.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-11.jpg'),
        userName: '@infinity_art',
        followersText: '1.4k Followers',
        authorName: 'Infinity Art',
        desc: 'Complete account of the system, and expound the actual things.',
      ...
      {
        id: 12,
        img: getImg('files/images/thumb/nft19.jpg'),
        imgLg: getImg('files/images/thumb/nft-lg12.jpg'),
        ...
        metaTextTwo: '200 editions',
        metaTextThree: 'Highest bid <span class="text-primary fw-semibold">1.072 ETH</span>',
        avatar: getImg('files/images/thumb/avatar-12.jpg'),
        userName: '@viktoria',
        followersText: '1.4k Followers',
        authorName: 'Viktoria',
        desc: 'Complete account of the system, and expound the actual things.',
  ...
  creatorData: {
    ...
    creatorList: [
      ...
      },
      {
        ...
        title: '@mark_hardson',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-6.jpg'),
        path: '/author'
      },
    ],
    creatorListTwo: [
      ...
      },
      {
        ...
        title: 'Gayle Hicks',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-7.jpg'),
        path: '/author'
      },
      {
        id: 8,
        title: 'Claude Banks',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-8.jpg'),
        path: '/author'
      },
      {
        id: 9,
        title: 'Stacy Long',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-9.jpg'),
        path: '/author'
      },
      {
        id: 10,
        title: 'Fred Ryan',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-10.jpg'),
        path: '/author'
      },
      {
        id: 11,
        ...
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-11.jpg'),
        path: '/author'
      },
      {
        id: 12,
        title: 'Karla Sharp',
        subTitle: '34.57 ETH',
        img: getImg('files/images/thumb/avatar-12.jpg'),
        path: '/author'
      },
    ]
  },
    ...
    collectionList: [
      {
        ...
        price: '$26,220',
        img: getImg('files/images/thumb/art-5.jpg'),
        avatar: getImg('files/images/thumb/avatar.jpg'),
        path: ''
      },
      {
        ...
        title: 'Savage Dogs',
        price: '$24,497',
        img: getImg('files/images/thumb/art-6.jpg'),
        avatar: getImg('files/images/thumb/avatar-2.jpg'),
        path: ''
      },
      {
        ...
        title: 'Crappy Dogecoin',
        price: '$26,220',
        img: getImg('files/images/thumb/art-7.jpg'),
        avatar: getImg('files/images/thumb/avatar-3.jpg'),
        path: ''
      },
      {
        ...
        title: 'Crypto Krills',
        price: '$11,356',
        img: getImg('files/images/thumb/art-8.jpg'),
        avatar: getImg('files/images/thumb/avatar-4.jpg'),
        path: ''
      },
      {
        ...
        title: 'Chibi Doge',
        price: '$4,234',
        img: getImg('files/images/thumb/art-9.jpg'),
        avatar: getImg('files/images/thumb/avatar-5.jpg'),
        path: ''
      }
    ]
  ...
  sellBuyData: [
    {
      id: 1,
      img: getImg('files/images/thumb/buy.png'),
    ...
    {
      id: 2,
      img: getImg('files/images/thumb/sell.png'),
  ...
  // itemDetail data
  itemDetailData: {
    img: getImg('files/images/thumb/nft-lg.jpg'),
    imgTwo: getImg('files/images/thumb/item-detail-2.jpg'),
  ...
  featuredCreatorsData: {
    ...
    featuredList: [
      {
        id: 1,
        img: getImg('files/images/thumb/art.jpg'),
        avatar: getImg('files/images/thumb/avatar.jpg'),
      ...
      {
        id: 2,
        img: getImg('files/images/thumb/art-2.jpg'),
        avatar: getImg('files/images/thumb/avatar-2.jpg'),
        title: 'Alex Smith',
        content: 'Complete account of the system, and expound the actual things.',
        followerNum: '202',
      ...
      {
        id: 3,
        img: getImg('files/images/thumb/art-3.jpg'),
        avatar: getImg('files/images/thumb/avatar-3.jpg'),
        title: 'Kevin Martin',
        content: 'Complete account of the system, and expound the actual things.',
        followerNum: '343',
      ...
      {
        id: 4,
        img: getImg('files/images/thumb/art-4.jpg'),
        avatar: getImg('files/images/thumb/avatar-4.jpg'),
        title: 'Jhonatan Doe',
        content: 'Complete account of the system, and expound the actual things.',
        followerNum: '315',
  ...
  funfactData: {
    funfactList: [
      {
        id: 1,
        icon: getImg('files/images/thumb/icon-employees.svg'),
        title: 'Over 400+',
        subTitle: 'Total Members'
      },
      {
        id: 2,
        icon: getImg('files/images/thumb/icon-users.svg'),
        title: 'Over 40+',
        subTitle: 'Total Countries'
      },
      {
        id: 3,
        icon: getImg('files/images/thumb/icon-nfts.svg'),
        title: 'Over 1000+',
        subTitle: 'Total NFTs'
      }
    ],
    funfactListTwo: [
      {
        id: 1,
        icon: getImg('files/images/thumb/icon-timeline.svg'),
        title: '2015',
        subTitle: 'Founded'
      },
      {
      ...
      {
        id: 4,
        icon: getImg('files/images/thumb/icon-collections.svg'),
        title: '1M',
      ...
      {
        id: 6,
        icon: getImg('files/images/thumb/icon-money.svg'),
        title: '$2B+',
        subTitle: 'Volume'
      }
    ]
  ...
  blogData: {
    ...
    blogList: [
      {
        id: 1,
        img: getImg('files/images/thumb/blog-img.jpg'),
        avatar: getImg('files/images/thumb/avatar-2.jpg'),
        title: "Enter Linda Dounia's Cyber Baat World",
        userName: 'Alex Smith',
      ...
      {
        id: 2,
        img: getImg('files/images/thumb/blog-img-2.jpg'),
        avatar: getImg('files/images/thumb/avatar-3.jpg'),
      ...
      {
        id: 3,
        img: getImg('files/images/thumb/blog-img-3.jpg'),
        avatar: getImg('files/images/thumb/avatar-4.jpg'),
      ...
      {
        id: 4,
        img: getImg('files/images/thumb/blog-img-4.jpg'),
        avatar: getImg('files/images/thumb/avatar-4.jpg'),
    ...
    blogListTwo: [
      ...
      {
        id: 5,
        img: getImg('files/images/thumb/blog-img-5.jpg'),
        avatar: getImg('files/images/thumb/avatar-5.jpg'),
      ...
      {
        id: 6,
        img: getImg('files/images/thumb/blog-img-6.jpg'),
        avatar: getImg('files/images/thumb/avatar-5.jpg'),
  ...
  blogDetail: {
    ...
    imgList: [
      getImg('files/images/thumb/blog-img.jpg'),
      getImg('files/images/thumb/blog-img-2.jpg')
    ],
    tags: [
      {
        id: 1,
  ...
  authorPublicData: {
    ...
    btnLink: '',
    img: getImg('files/images/thumb/avatar-8.jpg'),
    coverImg: getImg('files/images/thumb/bread-bg-2.jpg')
  },
  authorSidebarData: {
    authorTabNav: [
      {
    ...
    logos: [
      {
        id: 1,
        path: '',
        img: getImg('files/images/thumb/google-play.png')
      },
      {
        id: 2,
        path: '',
        img: getImg('files/images/thumb/app-store.png')
      }
    ],
    ...
    receiveItems: [
      {
        ...
        title: 'Eternal Zen',
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img.jpg'),
      ...
      },
      {
        ...
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img-2.jpg'),
        addressText: 'Contact Address',
        addressTextTwo: '08 W 36th St, New York, NY 10001',
        actionList: [
          {
      ...
      },
      {
        ...
        title: 'Dance or Die',
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img-3.jpg'),
        addressText: 'Contact Address',
        addressTextTwo: '08 W 36th St, New York, NY 10001',
        actionList: [
          {
      ...
      },
      {
        ...
        title: 'Genesis.001',
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img-4.jpg'),
        addressText: 'Contact Address',
        addressTextTwo: '08 W 36th St, New York, NY 10001',
        actionList: [
          {
      ...
      },
      {
        ...
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img-5.jpg'),
        addressText: 'Contact Address',
        addressTextTwo: '08 W 36th St, New York, NY 10001',
        actionList: [
          {
      ...
      },
      {
        ...
        title: 'Detritus #17',
        path: '/product-details-v1-1',
        img: getImg('files/images/thumb/small-img-6.jpg'),
        addressText: 'Contact Address',
        addressTextTwo: '08 W 36th St, New York, NY 10001',
        actionList: [
          {
    ...
    transactionsTableBody: [
      {
        ...
        timeText: '10-05-2019',
        price: '$599.00',
        img: getImg('files/images/brand/visa.png'),
        badgeText: 'Approved',
      ...
      },
      {
        ...
        timeText: '10-05-2019',
        price: '$599.00',
        img: getImg('files/images/brand/paypal.png'),
        badgeText: 'Approved',
        badgeClass: 'bg-success'
      },
      {
        ...
        timeText: '10-05-2019',
        price: '$99.00',
        img: getImg('files/images/brand/a-express.png'),
        badgeText: 'Declined',
        badgeClass: 'bg-danger'
      },
      {
  ...
  creditCardList: [
    {
      ...
      timeText: '08/11/2022',
      img: getImg('files/images/thumb/visa.png'),
    ...
    },
    {
      ...
      timeText: '02/9/2022',
      img: getImg('files/images/thumb/master-card.png'),
      titleTwo: 'Billing address',
    ...
    cards: [
      {
        id: 1,
        title: 'Single',
        img: getImg('files/images/thumb/single-mobile.png'),
        path: 'create-single'
      },
      {
        id: 1,
        title: 'Mutiple',
        img: getImg('files/images/thumb/multiple-mobile.png'),
        path: 'create-multiple'
      }
    ],
  ...
  depositData: {
    ...
    contentTwo: 'Metamask browser extension is getImgd. Visit <a href="https://metamask.io/">metamask.io</a> to learn more.',
  ...
  depositNiftyModal: {
    ...
    img: getImg('files/images/thumb/qrcode.png'),
  ...
  deleteModal: {
    ...
    img: getImg('files/images/thumb/exclamation-circle-solid.svg'),
    btnText: 'Cancel',
  ...
  aboutData: {
    ...
    img: getImg('files/images/thumb/nft-img-2.png')
  },
  aboutDataTwo: {
    ...
    img: getImg('files/images/thumb/about-img.jpg')
  },
  brandData: {
    ...
    brandList: [
      {
        id: 1,
        img: getImg('files/images/brand/brand.png'),
        itemToShow: 'show'
      },
      {
        id: 2,
        img: getImg('files/images/brand/brand-2.png'),
        itemToShow: 'show'
      },
      {
        id: 3,
        img: getImg('files/images/brand/brand-3.png'),
        itemToShow: 'show'
      },
      {
        id: 4,
      ...
      {
        id: 6,
        img: getImg('files/images/brand/brand-4.png')
      },
      {
        id: 7,
        img: getImg('files/images/brand/brand.png')
  ...
  teamData: {
    ...
    teamList: [
      {
        id: 1,
        img: getImg('files/images/client/a.jpg'),
        title: 'Jessica brown',
        meta: 'Co-founder of Scalar'
      },
      {
        id: 2,
        img: getImg('files/images/client/b.jpg'),
        title: 'Tim Ferris',
        meta: 'Entrepreneur'
      },
      {
        id: 3,
        img: getImg('files/images/client/c.jpg'),
        title: 'Belinda Johnson',
        meta: 'Attorney of Airbnb'
      },
      {
        id: 4,
        img: getImg('files/images/client/d.jpg'),
        title: 'Justin Kan',
        meta: 'Co-founder of Twitch'
      },
      {
        id: 5,
        img: getImg('files/images/client/e.jpg'),
        title: 'Alexis Ohanian',
        meta: 'Co-founder of Reddit'
      },
      {
        id: 6,
        img: getImg('files/images/client/f.jpg'),
  ...
  walletData: [
    {
      id: 1,
      img: getImg('files/images/brand/metamask.svg'),
      title: 'Metamask',
    ...
    {
      id: 2,
      img: getImg('files/images/brand/bitski.svg'),
      title: 'Bitski',
    ...
    {
      id: 3,
      img: getImg('files/images/brand/fortmatic.svg'),
      title: 'Fortmatic',
    ...
    {
      id: 4,
      img: getImg('files/images/brand/torus.svg'),
      title: 'Torus',
    ...
    {
      id: 5,
      img: getImg('files/images/brand/coinbase.svg'),
      title: 'Coinbase',
      content: 'The easiest and most secure crypto wallet. No Coinbase account getImgd to connect EnftyMart.',
      btnText: 'Connect',
      path: 'login'
    },
    {
      id: 6,
      img: getImg('files/images/brand/wallet-connect.svg'),
      title: 'WalletConnect',
      content: 'Open source protocol for connecting decentralised applications to mobile wallets.',
      btnText: 'Connect',
      path: 'login'
  ...
  formData: {
    ...
    content: 'Your email address will not be published. getImgd fields are marked *'
  },
  loginData: {
    img: getImg('files/images/thumb/remote.png'),
    title: 'Welcome Back!',
  ...
  // register data
  registerData: {
    img: getImg('files/images/thumb/remote-2.png'),
  ...
  activityNavList: [
    {
      id: 1,
      class: 'active',
      icon: getImg('files/images/thumb/all.svg'),
      title: 'All',
      slug: 'all-tab',
      bsTarget: '#all'
    },
    {
      id: 2,
      icon: getImg('files/images/thumb/art.svg'),
      title: 'Art',
      slug: 'art-tab',
      bsTarget: '#art'
    },
    {
      id: 3,
      icon: getImg('files/images/thumb/virtual-world.svg'),
      title: 'Virtual Worlds',
    ...
    {
      id: 4,
      icon: getImg('files/images/thumb/icon4.svg'),
      title: 'Trending Cards',
    ...
    {
      id: 5,
      icon: getImg('files/images/thumb/icon5.svg'),
      title: 'Collectibles',
    ...
    {
      id: 6,
      icon: getImg('files/images/thumb/icon6.svg'),
      title: 'Utility',
      slug: 'utility-tab',
      bsTarget: '#utility'
    },
