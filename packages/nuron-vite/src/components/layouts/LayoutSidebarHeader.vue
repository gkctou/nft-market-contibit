                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner text-center">
                            <div class="logo logo-custom-css">
                                <router-link class="logo-light" to="/"><img :src="`/assets/images/logo/logo-white.png`" alt="nft-logo"></router-link>
                                <router-link class="logo-dark" to="/"><img :src="`/assets/images/logo/logo-dark.png`" alt="nft-logo"></router-link>
                            </div>
