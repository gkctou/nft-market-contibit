    ...
    <div class="container px-4 mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
          <span class="inline-block text-xs text-gray-50 uppercase">Lorem ipsum</span>
          <h2 class="mt-2 mb-6 text-4xl lg:text-5xl text-white font-bold font-heading">Lorem ipsum dolor sit amet consectutar</h2>
  ...
  <section class="bg-sky-500 py-20">
    <div class="container px-4 mx-auto">
      <div class="mb-16 text-center">
        <span class="text-sm text-gray-200 uppercase">Lorem ipsum</span>
        <h2 class="mt-2 text-4xl lg:text-5xl text-white font-bold font-heading">Lorem ipsum dolor</h2>
      </div>
    ...
    <div class="container px-4 mx-auto">
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full lg:w-1/2 p-4">
          <img class="w-full h-80 object-cover rounded-lg" src="mockup-assets/images/gray-500-horizontal.png" alt="">
        </div>
        <div class="w-full lg:w-1/2 p-4">
          <img class="w-full h-80 object-cover rounded-lg" src="mockup-assets/images/gray-500-horizontal.png" alt="">
        </div>
        <div class="w-full md:w-1/3 p-4">
          <img class="w-full h-80 object-cover rounded-lg" src="mockup-assets/images/gray-500-square.png" alt="">
        </div>
        <div class="w-full md:w-1/3 p-4">
          <img class="w-full h-80 object-cover rounded-lg" src="mockup-assets/images/gray-500-square.png" alt="">
        </div>
